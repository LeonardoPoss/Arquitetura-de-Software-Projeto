import os
import json
from kaggle.api.kaggle_api_extended import KaggleApi  # Importando a API do Kaggle

class KaggleAuthenticator:
    def __init__(self, cred_path="kaggle.json"):
    ...
    def get_api(self):
        ...
        self.carregar_credenciais()  # Carrega as credenciais e configura as variáveis de ambiente
        api = KaggleApi()
        api.authenticate()  # Autentica na API do Kaggle
        return api  # Retorna a instância da API autenticada